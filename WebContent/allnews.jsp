            ...
            <%
                ...
                if (intPageCount > 0) {
                    ...
                    while(i < intPageSize && resultIterator.hasNext()) {
                        ...
                        out.println("<p><a href=\"" + url + "\">" + result.get(url) + "</a>");
                        out.println("<br />");
                        out.println(url);
                        out.println("</p>");
                        i = i + 1;
                ...
                out.println("<br />");
                out.println("<p>Page:" + intPage + " " + "Total:" + intPageCount + "</p>");
                
                out.println("<p>");
                if (intPage > 1) {
                    out.println("<a href=\"");
                    out.println("allnews.jsp?page=" + (intPage - 1));
                    out.println("&lastMapPos=" + (intPage * intPageSize - 2 * intPageSize) + "\">");
    ...
    <div class="container">
        ...
        <div class="content">
            <table width="100%" border="0" cellspacing="10">
                <tr>
                    <td width="15%"><ul id="MenuBar1" class="MenuBarVertical">
                            <li><a href="Display?category=Politics">Politics</a></li>
                            <li><a href="Display?category=Business">Business</a></li>
                            <li><a href="Display?category=Technology">Technology</a></li>
                            <li><a href="Display?category=National">National</a></li>
                            <li><a href="Display?category=International">International</a></li>
                            <li><a href="Display?category=Health">Health</a></li>
                            <li><a href="Display?category=Entertainment">Entertainment</a></li>
                        </ul></td>
                    <td width="85%"></td>
                </tr>
            </table>
